...
namespace Helios
{
    ...
    public class ManipBasedeDonnees
    {
        ...
        {
            /* Cette méthode permet la connexion avec la base de données tout en exécutant une commande cmd sur la table de wilaya " wilaya" et rend con un booleen qui à vrai en cas de 
